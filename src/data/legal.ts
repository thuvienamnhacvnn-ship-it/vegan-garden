...
export const impressum: LegalPage = {
  title: { de: 'Impressum', en: 'Legal Notice', vi: 'Thông tin pháp lý (Impressum)' },
  intro: {
  ...
  sections: [
    {
      heading: { de: 'Anbieter', en: 'Provider', vi: 'Đơn vị vận hành' },
      paragraphs: {
        de: [
        ...
        en: [
          'Vegan Garden Berlin [PLACEHOLDER: full legal company name, e.g. Vegan Garden Berlin GmbH]',
          'Frankfurter Allee 21, 10247 Berlin, Germany',
          'Represented by: [PLACEHOLDER: name of the managing director]',
        ],
        vi: [
    ...
    {
      heading: { de: 'Kontakt', en: 'Contact', vi: 'Liên hệ' },
      paragraphs: {
        de: [
        ...
        en: [
          'Phone: +49 30 120 88 89 2 [taken from the design draft – confirm before launch]',
          'E-mail: info@vegangarden-berlin.de [taken from the design draft – confirm before launch]',
        ],
        vi: [
    ...
    {
      heading: { de: 'Registereintrag & Umsatzsteuer', en: 'Commercial register & VAT', vi: 'Đăng ký doanh nghiệp & thuế' },
      paragraphs: {
        de: [
        ...
        en: [
          'Register court: [PLACEHOLDER] · Register number: [PLACEHOLDER]',
    ...
    },
    {
      ...
      paragraphs: {
        ...
        en: [
          'Pursuant to § 18 (2) MStV: [PLACEHOLDER: name], Frankfurter Allee 21, 10247 Berlin.',
        ],
        vi: ['Theo § 18 khoản 2 MStV: [CHỖ TRỐNG: họ tên], Frankfurter Allee 21, 10247 Berlin.'],
      },
    },
    {
      heading: { de: 'EU-Streitschlichtung', en: 'EU dispute resolution', vi: 'Giải quyết tranh chấp EU' },
      paragraphs: {
        de: [
    ...
    {
      heading: { de: 'Bildnachweis', en: 'Image credits', vi: 'Bản quyền hình ảnh' },
      paragraphs: {
        de: ['Alle Fotos und das Logo: Vegan Garden Berlin, sofern nicht anders angegeben.'],
        en: [
          'All photographs and the logo: Vegan Garden Berlin, unless stated otherwise.',
        ],
...
export const privacy: LegalPage = {
  title: { de: 'Datenschutzerklärung', en: 'Privacy Policy', vi: 'Chính sách bảo mật' },
  intro: {
    ...
    en: 'We treat your personal data confidentially and in accordance with the General Data Protection Regulation (GDPR) and this privacy policy.',
  ...
  sections: [
    {
      heading: { de: 'Verantwortliche Stelle', en: 'Controller', vi: 'Đơn vị chịu trách nhiệm' },
      paragraphs: {
        de: [
        ...
        en: [
          'The controller within the meaning of the GDPR is the provider named in the legal notice, Frankfurter Allee 21, 10247 Berlin.',
          'For questions about data protection you can reach us at info@vegangarden-berlin.de.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Reservierungen', en: 'Reservations', vi: 'Dữ liệu đặt bàn' },
      paragraphs: {
        de: [
        ...
        en: [
          'When you reserve a table we process your name, e-mail address, phone number, date, time, number of guests and any voluntary details about allergies and requests.',
          'The legal basis is Art. 6 (1) (b) GDPR (steps taken prior to entering into a contract). The data is used solely to handle your reservation and is deleted after 6 months at the latest, unless statutory retention periods apply.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Online-Bestellungen', en: 'Online orders', vi: 'Dữ liệu đặt món online' },
      paragraphs: {
        de: [
        ...
        en: [
          'For pickup and delivery we additionally process the items you ordered and – for delivery – your delivery address.',
          'The legal basis is Art. 6 (1) (b) GDPR. Retention periods under commercial and tax law remain unaffected.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Lokale Speicherung im Browser', en: 'Local storage in your browser', vi: 'Lưu trữ cục bộ trên trình duyệt' },
      paragraphs: {
        de: [
        ...
        en: [
          'This website sets no tracking cookies. We store only technically necessary information in your browser (localStorage): the language you chose and the contents of your cart.',
          'This data never leaves your device and can be deleted at any time through your browser settings.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Google Maps', en: 'Google Maps', vi: 'Google Maps' },
      paragraphs: {
        de: [
        ...
        en: [
          'On the contact page we embed a map from Google Maps (provider: Google Ireland Limited). When the map loads, your IP address is transmitted to Google.',
          'The legal basis is our legitimate interest in providing simple directions, Art. 6 (1) (f) GDPR. Further information: https://policies.google.com/privacy',
        ],
        vi: [
    ...
    {
      heading: { de: 'Newsletter', en: 'Newsletter', vi: 'Bản tin' },
      paragraphs: {
        de: [
        ...
        en: [
          'For the newsletter we process your e-mail address on the basis of your consent, Art. 6 (1) (a) GDPR.',
          'You can withdraw your consent at any time, for example via the unsubscribe link in every e-mail.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Ihre Rechte', en: 'Your rights', vi: 'Quyền của bạn' },
      paragraphs: {
        de: [
        ...
        en: [
          'You have the right to access, rectification, erasure, restriction of processing and data portability, as well as the right to object to processing.',
          'You also have the right to lodge a complaint with a supervisory authority – in Berlin, the Berlin Commissioner for Data Protection and Freedom of Information.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Hosting und Serverlogs', en: 'Hosting and server logs', vi: 'Hosting và nhật ký máy chủ' },
      paragraphs: {
        de: [
        ...
        en: [
          'When the website is accessed, the hosting provider automatically collects server log files (IP address, time, page requested, browser type). This data serves secure operation and is deleted after a short time.',
...
export const terms: LegalPage = {
  title: { de: 'Allgemeine Geschäftsbedingungen', en: 'Terms and Conditions', vi: 'Điều khoản chung' },
  intro: {
    de: 'Diese Bedingungen gelten für Tischreservierungen sowie für Bestellungen zur Abholung und Lieferung über diese Website.',
    en: 'These terms apply to table reservations and to orders for pickup and delivery placed through this website.',
    vi: 'Các điều khoản sau áp dụng cho việc đặt bàn cũng như đặt món để đến lấy hoặc giao hàng qua website này.',
  },
  updated: '2026-08-01',
  sections: [
    {
      heading: { de: 'Geltungsbereich', en: 'Scope', vi: 'Phạm vi áp dụng' },
      paragraphs: {
        de: [
        ...
        en: [
          'The contracting party is the provider named in the legal notice. Differing terms proposed by the guest apply only if we agree to them expressly and in writing.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Reservierungen', en: 'Reservations', vi: 'Đặt bàn' },
      paragraphs: {
        de: [
        ...
        en: [
          'A reservation request made through this website is not binding until we confirm it. We hold reserved tables for 15 minutes beyond the agreed time.',
          'Please cancel in good time if you cannot make it – that way we can offer the table to other guests.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Bestellungen und Preise', en: 'Orders and prices', vi: 'Đơn hàng và giá' },
      paragraphs: {
        de: [
        ...
        en: [
          'All prices are in euros and include statutory VAT. The contract is concluded when we confirm your order.',
          'A minimum order value applies to deliveries; the delivery fee is shown before you submit the order.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Zahlung', en: 'Payment', vi: 'Thanh toán' },
      paragraphs: {
        de: [
        ...
        en: [
          'In the current version of this website, payment is made on pickup or on delivery. Online payment is prepared but not yet active.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Widerrufsrecht', en: 'Right of withdrawal', vi: 'Quyền huỷ đơn' },
      paragraphs: {
        de: [
        ...
        en: [
          'For the delivery of food and drink that can spoil quickly, there is no right of withdrawal pursuant to § 312 g (2) nos. 2 and 4 BGB.',
          'Please call us straight away if something is wrong with your order – we will find a solution.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Allergene und Unverträglichkeiten', en: 'Allergens and intolerances', vi: 'Dị ứng và không dung nạp' },
      paragraphs: {
        de: [
        ...
        en: [
          'All dishes are entirely plant-based. We work in an open kitchen; traces of gluten, soy, sesame and nuts cannot be fully ruled out.',
          'Please tell us about allergies before ordering so that we can advise you properly.',
        ],
        vi: [
    ...
    {
      heading: { de: 'Anwendbares Recht', en: 'Applicable law', vi: 'Luật áp dụng' },
      paragraphs: {
        de: ['Es gilt deutsches Recht. Gerichtsstand ist Berlin, soweit gesetzlich zulässig.'],
        en: [
          'German law applies. The place of jurisdiction is Berlin, to the extent legally permissible.',
        ],
