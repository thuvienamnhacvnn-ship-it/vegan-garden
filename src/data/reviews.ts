...
export const reviews: Review[] = [
  {
    ...
    author: 'Lena M.',
    origin: {
      de: 'Berlin-Friedrichshain',
      en: 'Berlin-Friedrichshain',
      vi: 'Berlin-Friedrichshain',
    },
    rating: 5,
    source: 'google',
    text: {
      ...
      en: 'The best vegan pho I have eaten in Berlin. You can taste the hours that went into the broth – and the room is so calm you just leave your phone on the table.',
  ...
  },
  {
    id: 'tuan',
    author: 'Tuấn N.',
    origin: { de: 'Hamburg', en: 'Hamburg', vi: 'Hamburg' },
    rating: 5,
    source: 'tripadvisor',
    text: {
      ...
      en: 'As a Vietnamese I was sceptical that purely plant-based could work. The Bún Chả Chay convinced me straight away – it tastes like home.',
  ...
  },
  {
    id: 'sophie',
    author: 'Sophie K.',
    origin: { de: 'Berlin-Kreuzberg', en: 'Berlin-Kreuzberg', vi: 'Berlin-Kreuzberg' },
    rating: 5,
    source: 'google',
    text: {
      ...
      en: 'A beautiful place full of green. The team took my gluten intolerance seriously and talked me through every dish. Very attentive.',
  ...
  },
  {
    id: 'marco',
    author: 'Marco B.',
    origin: { de: 'Berlin-Mitte', en: 'Berlin-Mitte', vi: 'Berlin-Mitte' },
    rating: 4,
    source: 'guest',
    text: {
      ...
      en: 'I normally eat meat and came here for a business lunch. The tofu with asparagus was so good that I did not miss it at all.',
  ...
  },
  {
    id: 'anh',
    author: 'Anh T.',
    origin: { de: 'Berlin-Lichtenberg', en: 'Berlin-Lichtenberg', vi: 'Berlin-Lichtenberg' },
    rating: 5,
    source: 'guest',
    text: {
      ...
      en: 'We celebrate my mother’s birthday here every year. The team puts the tables together, brings tea and simply lets us take our time.',
  ...
  },
  {
    id: 'jonas',
    author: 'Jonas W.',
    origin: { de: 'Potsdam', en: 'Potsdam', vi: 'Potsdam' },
    rating: 5,
    source: 'tripadvisor',
    text: {
      ...
      en: 'Good value, honest portions, and the coconut coffee at the end is a must. We now come over from Potsdam regularly.',
